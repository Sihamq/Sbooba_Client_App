                  ...
                  Padding(
                    ...
                    child: controller.profile != null
                        ? Row(
                            ...
                            children: [
                              TotalContainer(
                                  secondText: "totalOrder".tr,
                                  total: controller.profile!.data!.totalOrders),
                              SizedBox(
                                width: .5.h,
                              ),
                              TotalContainer(
                                total: controller.profile!.data!.totalProducts,
                              ...
                              TotalContainer(
                                ...
                                total: controller.profile!.data!.acceptOrders,
                              ),
                              SizedBox(
                                width: .5.h,
                              ),
                              TotalContainer(
                                ...
                                total: controller.profile!.data!.canceledOrders,
                              )
                            ],
                          )
                        : Center(
